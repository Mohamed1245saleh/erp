...
@section('content')
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a id="inventoryDone" class="nav-link active" href="#">منتجات مجرودة</a>
        </li>
        <li class="nav-item">
            <a id="inventoryUndone" class="nav-link" href="#">منتجات غير مجرودة</a>
        </li>
    </ul>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header text-center" style="background-color:#484848;color:#EDAF11;font-size: 30px;">
                @lang("inventory.products_reports")
            </div>
        </div>
        <div class="box-body">
            <div class="row">
        ...
        <table id="doneProducts" class="display nowrap" style="width:100%">
            ...
            <tbody>
              @include("inventory.partials.inventoryDoneList" , [$inventories , $quantityProductsArray])
            </tbody>

        </table>

        <table id="undoneProducts" class="nowrap" style="width:100%">
            <thead>
            <tr>
                <th  style="text-align: right">@lang("inventory.product_name")</th>
                <th  style="text-align: right">@lang("inventory.product_barcode")</th>
            ...
            <tbody>
            @include("inventory.partials.inventoryNotDoneList" , $notExistsProducts)
            </tbody>
